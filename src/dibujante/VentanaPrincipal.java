...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        menuItemOctagono = new javax.swing.JRadioButtonMenuItem();
        menuItemPentagono = new javax.swing.JRadioButtonMenuItem();
        ...
        grupoBotonesFiguras.add(btnOctagono);
        btnOctagono.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/059octagon_99897 (1).png"))); // NOI18N
        ...
        btnKite.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jMenu2.add(btnKite);
        ...
        menuItemAnillo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menuItemAnilloActionPerformed(evt);
            }
        });
        jMenu2.add(menuItemAnillo);

        grupoBotonesFiguras.add(menuItemOctagono);
        menuItemOctagono.setText("Octagono");
        menuItemOctagono.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/059octagon_99897 (1).png"))); // NOI18N
        jMenu2.add(menuItemOctagono);

        grupoBotonesFiguras.add(menuItemPentagono);
        menuItemPentagono.setSelected(true);
        menuItemPentagono.setText("Pentagono");
        menuItemPentagono.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/pentagon.png"))); // NOI18N
        jMenu2.add(menuItemPentagono);
  ...
  private void btnColorBordeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnColorBordeActionPerformed
   ...
   private void btnCrescentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrescentActionPerformed
    ...
    private void menuItemAnilloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuItemAnilloActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_menuItemAnilloActionPerformed
    ...
    private javax.swing.JRadioButtonMenuItem menuItemOctagono;
    private javax.swing.JRadioButtonMenuItem menuItemParalelogramo;
    private javax.swing.JRadioButtonMenuItem menuItemPentagono;
   ...
   public javax.swing.JRadioButtonMenuItem getMenuitemCrescent() {
    ...
    public javax.swing.JRadioButtonMenuItem getMenuitemOctagono() {
      return menuItemOctagono;
   }
    public javax.swing.JRadioButtonMenuItem getMenuitemPentagono() {
      return menuItemPentagono;
   }
    ...
    public JToggleButton getBtnParallelogram() {
        return btnParallelogram;
    }
   ...
   public javax.swing.JToggleButton getBtnCrescent() {
    ...
    public javax.swing.JToggleButton getBtnAnillo() {
     ...
     public javax.swing.JToggleButton getBtnOctagono() {
        return btnOctagono;
    }
    public javax.swing.JToggleButton getBtnPentagono() {
        return btnPentagon;
    }
